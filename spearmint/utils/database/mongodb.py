...
class MongoDB(AbstractDB):
    ...
    def save(self, save_doc, experiment_name, experiment_field, field_filters=None):
        ...
        # dbdocs can return more than one thing - but we want to return find(field_filters)
    ...
    def load(self, experiment_name, experiment_field, field_filters=None):
        ...
        if len(dbdocs) == 0:
            ...
            print(decompress_nested_container(dbdocs[0]))
            return decompress_nested_container(dbdocs[0])
        else:
            print([decompress_nested_container(dbdoc) for dbdoc in dbdocs])
